...
const AnimatedBackground = () => {
  ...
  return (
    <div className={styles.waveContainer}>
      ...
      >
        <path d="M0,320L48,341.3C96,363,192,405,288,416C384,427,480,405,576,378.7C672,352,768,320,864,330.7C960,341,1056,395,1152,421.3C1248,448,1344,448,1392,448L1440,448L1440,1000L1392,1000C1344,1000,1248,1000,1152,1000C1056,1000,960,1000,864,1000C768,1000,672,1000,576,1000C480,1000,384,1000,288,1000C192,1000,96,1000,48,1000L0,1000Z"></path>
      </svg>
      <svg
        ...
        viewBox="0 0 1440 1000"
      >
        <path d="M0,480L48,474.7C96,469,192,448,288,453.3C384,459,480,491,576,512C672,533,768,544,864,517.3C960,491,1056,427,1152,416C1248,405,1344,448,1392,469.3L1440,491L1440,1000L1392,1000C1344,1000,1248,1000,1152,1000C1056,1000,960,1000,864,1000C768,1000,672,1000,576,1000C480,1000,384,1000,288,1000C192,1000,96,1000,48,1000L0,1000Z"></path>
      </svg>
      <svg
