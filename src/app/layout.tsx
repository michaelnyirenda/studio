              ...
              <TooltipTrigger asChild>
                <Link href="/faq" passHref>
                  <Button
                    ...
                    className="fixed bottom-24 left-8 h-16 w-16 rounded-full shadow-2xl bg-card hover:bg-secondary border-2 border-primary z-50 flex items-center justify-center group"
                  >
                    <HelpCircle className="h-10 w-10 text-primary transition-transform group-hover:scale-110" strokeWidth={2.5} />
                  </Button>
                </Link>
              </TooltipTrigger>
